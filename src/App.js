            ...
            <nav className="navbar fixed-top navbar-expand-lg navbar-light bg-warning">
              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav nav-fill w-100">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="#pizza">Loại Pizza</a>
                  </li>
                  <a className="nav-link" href="#contact">Gửi đơn hàng</a>
                </ul>
              </div>
            </nav>
          </div>
                  ...
                  <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                    ...
                    <div className="carousel-inner">
                      <div className="carousel-item active">
                        <img className="d-block w-100" src={IMAGES.image1} alt="First slide" />
                      </div>
                      <div className="carousel-item">
                        <img className="d-block w-100" src={IMAGES.image2}  alt="Second slide"/>
                      </div>
                      <div className="carousel-item">
                        <img className="d-block w-100"  src={IMAGES.image3} alt="Third slide" />
                      </div>
                      <div className="carousel-item">
                        <img className="d-block w-100" src={IMAGES.image4}  alt="4 slide" />
                      </div>
                      <div className="carousel-item">
                        <img className="d-block w-100"  src={IMAGES.salad} alt="5 slide" />
                      </div>
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-4">
                      <div className="card">
                        ...
                        <div className="card-footer text-center">
                          <button id="btn-plan-l" className="btn btn-warning btn-block font-weight-bold" data-is-selected-menu="N">Chọn</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="col-sm-4">
                      <div className="card w-100" style={{ width: "18rem" }}>
                        <img src={IMAGES.seafood} className="card-img-top" alt='seafood'/>
                        <div className="card-body">
                          ...
                          <p>
                            <button id="btn-pizza-1" className="btn btn-warning btn-block font-weight-bold" data-is-selected-pizza="N">Chọn</button>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-sm-4">
                      <div className="card w-100" style={{ width: "18rem" }}>
                        ...
                        <div className="card-body" style={{width:"25.6rem"}}>
                          ...
                          <p>
                            <button id="btn-pizza-2" className="btn btn-warning btn-block font-weight-bold" data-is-selected-pizza="N">Chọn</button>
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-sm-4">
                      <div className="card w-100" style={{ width: "18rem" }}>
                        <img src={IMAGES.bacon} className="card-img-top" alt='bacon' />
                        <div className="card-body">
                          ...
                          <p>
                            <button id="btn-pizza-3" className="btn btn-warning btn-block font-weight-bold" data-is-selected-pizza="N">Chọn</button>
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    <div className="col-sm-12">
                      ...
                      <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="inp-voucher-id" placeholder="mã giảm giá" />
                      </div>
                      <div className="form-group">
                        <label htmlFor="message">Lời nhắn</label>
                        <input type="text" className="form-control" id="inp-message" placeholder="Lời nhắn" />
                      </div>
                      <button id="sendModal" type="button" className="btn btn-warning w-100 font-weight-bold">Gửi</button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="container-fluid bg-orange-more p-5">
        <div className="row text-center">
          <div className="col-sm-12">
            ...
            <a href="#home" className="btn btn-dark m-3">
